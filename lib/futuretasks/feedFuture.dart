...
String bustType = 'Левая';

class feedFuturePage extends StatefulWidget {
  @override
  _feedFuturePageState createState() => _feedFuturePageState();
}

class _feedFuturePageState extends State<feedFuturePage> with SingleTickerProviderStateMixin {
  TextEditingController _controllerBustType;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                          ...
                          children: <Widget>[
                            Column(
                                children: <Widget>[
                                  ...
                                  Text('Кормление', style: TextStyle(fontSize: 22.0, color: Color(bodyTextMajor), fontFamily: 'Roboto',fontWeight: FontWeight.w600, height: 1.5),),
                                  Text('$timerStatus', style: TextStyle(fontSize: 16.0, color: Color(bodyTextInstruction), fontFamily: 'Roboto')),
                                ]),
                            SizedBox(height: 40,),
                            SizedBox(
                                width:200,
                        ...
                        child:Stack(
                            children: <Widget>[
                              Container(
                                ...
                                child: Column(
                                    children: <Widget>[
                                      Text('Кормление грудью', style: TextStyle(fontSize: 18.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),),
                          ...
                          children: <Widget>[
                            Column(
                                children: <Widget>[
                                  ...
                                  Text('Кормление', style: TextStyle(fontSize: 22.0, color: Color(bodyTextMajor), fontFamily: 'Roboto',fontWeight: FontWeight.w600, height: 1.5),),
                                  Text('Какой грудью кормите', style: TextStyle(fontSize: 16.0, color: Color(bodyTextInstruction), fontFamily: 'Roboto')),
                                ]),
                            SizedBox(height: 40,),
                            GestureDetector(
                              onTap: () {
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Container(
                                      ...
                                      alignment: Alignment.center,
                                      child: Text('Левая', style: TextStyle(fontSize: 17.0, color: Color(roundMarker == 1 ? textFieldText : textFieldHint), fontFamily: 'Roboto'),textAlign: TextAlign.left,),
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Container(
                                      margin: EdgeInsets.fromLTRB(20,0,20,0),
                                      alignment: Alignment.center,
                                      child: Text('Правая', style: TextStyle(fontSize: 17.0, color: Color(roundMarker == 2 ? textFieldText : textFieldHint), fontFamily: 'Roboto'),textAlign: TextAlign.left,),
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Container(
                                      margin: EdgeInsets.fromLTRB(20,0,20,0),
                                      alignment: Alignment.center,
                                      child: Text('Обе', style: TextStyle(fontSize: 17.0, color: Color(roundMarker == 3 ? textFieldText : textFieldHint), fontFamily: 'Roboto'),textAlign: TextAlign.left,),
      ...
      bottomNavigationBar: switchScreen == 2 ? BottomAppBar(): switchScreen == 0 ? BottomAppBar(): BottomAppBar(
        color: Colors.transparent,
        child: Container(
          height: 75,
          child:ListView(
