...
String Ubath = 'Купались с пеной для ванны';
String Udate = '23.02.2020';
String Utime = '19:03';


class bathFuturePage extends StatefulWidget {
  @override
  _bathFuturePageState createState() => _bathFuturePageState();
}

class _bathFuturePageState extends State<bathFuturePage> with SingleTickerProviderStateMixin {
                        ...
                        child:Stack(
                            children: <Widget>[
                              Container(
                                ...
                                child: Column(
                                    children: <Widget>[
                                      Text('Купание ребенка', style: TextStyle(fontSize: 18.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),),
                          ...
                          children: <Widget>[
                            Column(
                                children: <Widget>[
                                  ...
                                  Text('Купание', style: TextStyle(fontSize: 22.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),)
                                ]),
                            SizedBox(height: 30,),
