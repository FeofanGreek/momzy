...
class walkFuturePage extends StatefulWidget {
  @override
  _walkFuturePageState createState() => _walkFuturePageState();
}

class _walkFuturePageState extends State<walkFuturePage> with SingleTickerProviderStateMixin {
