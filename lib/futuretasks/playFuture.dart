...
String Ubath = 'Сложили из кубиков пирамидку';
String Udate = '23.02.2020';
String Utime = '19:03';


class playFuturePage extends StatefulWidget {
  @override
  _playFuturePageState createState() => _playFuturePageState();
}

class _playFuturePageState extends State<playFuturePage> with SingleTickerProviderStateMixin {
                        ...
                        child:Stack(
                            children: <Widget>[
                              Container(
                                ...
                                child: Column(
                                    children: <Widget>[
                                      Text('Игра с ребенком', style: TextStyle(fontSize: 18.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),),
                          ...
                          children: <Widget>[
                            Column(
                                children: <Widget>[
                                  ...
                                  Text('Игра', style: TextStyle(fontSize: 22.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),)
                                ]),
                            SizedBox(height: 30,),
