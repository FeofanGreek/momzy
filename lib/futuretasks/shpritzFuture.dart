...
String Ubath = 'Вакцина БЦЖ';
String Udate = '23.02.2020';
String Utime = '19:03';


class shpritzFuturePage extends StatefulWidget {
  @override
  _shpritzFuturePageState createState() => _shpritzFuturePageState();
}

class _shpritzFuturePageState extends State<shpritzFuturePage> with SingleTickerProviderStateMixin {
                        ...
                        child:Stack(
                            children: <Widget>[
                              Container(
                                ...
                                child: Column(
                                    children: <Widget>[
                                      Text('Вакцинация ребенка', style: TextStyle(fontSize: 18.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),),
                          ...
                          children: <Widget>[
                            Column(
                                children: <Widget>[
                                  ...
                                  Text('Вакцинация', style: TextStyle(fontSize: 22.0, color: Color(bodyTextMajor), fontFamily: 'Roboto', height: 1.5),)
                                ]),
                            SizedBox(height: 30,),
