...
class shpritzPage extends StatefulWidget {
  @override
  _shpritzPageState createState() => _shpritzPageState();
}

class _shpritzPageState extends State<shpritzPage> with SingleTickerProviderStateMixin {
