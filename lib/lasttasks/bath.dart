...
class bathPage extends StatefulWidget {
  @override
  _bathPageState createState() => _bathPageState();
}

class _bathPageState extends State<bathPage> with SingleTickerProviderStateMixin {
