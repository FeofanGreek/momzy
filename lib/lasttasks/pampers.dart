...
class pampersPage extends StatefulWidget {
  @override
  _pampersPageState createState() => _pampersPageState();
}

class _pampersPageState extends State<pampersPage> with SingleTickerProviderStateMixin {
                                                    ...
                                                    Stack(
                                                      children: <Widget>[
                                                        Container(
                                                          ...
                                                          alignment: Alignment.centerLeft,
                                                          child: Text('Мокрый', style: TextStyle(fontSize: 16.0, color: Colors.black, fontFamily: 'Roboto'),textAlign: TextAlign.left,),
                                                    ...
                                                    child: Stack(
                                                      children: <Widget>[
                                                        Container(
                                                          margin: EdgeInsets.fromLTRB(20,0,20,0),
                                                          alignment: Alignment.centerLeft,
                                                          child: Text('Грязный', style: TextStyle(fontSize: 16.0, color: Colors.black, fontFamily: 'Roboto'),textAlign: TextAlign.left,),
                                                    ...
                                                    child: Stack(
                                                      children: <Widget>[
                                                        Container(
                                                          margin: EdgeInsets.fromLTRB(20,0,20,0),
                                                          alignment: Alignment.centerLeft,
                                                          child: Text('Мокрый и грязный', style: TextStyle(fontSize: 16.0, color: Colors.black, fontFamily: 'Roboto'),textAlign: TextAlign.left,),
